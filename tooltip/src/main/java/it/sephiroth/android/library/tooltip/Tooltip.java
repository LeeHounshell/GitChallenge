...
public final class Tooltip {
    ...
    static class TooltipViewImpl extends ViewGroup implements TooltipView {
        ...
        final Runnable activateRunnable = new Runnable() {
            @Override
            public void run() {
                mActivated = true;
            }
        ...
        private final AnimationBuilder mFloatingAnimation;
        ...
        public TooltipViewImpl(Context context, final Builder builder) {
            ...
            int def_textSize = getResources().getInteger(R.integer.ttlm_default_text_size);
            int difference = (def_textSize - getTextSize());
            mSizeTolerance += difference;
        ...
        void fadeOut(long fadeDuration) {
        ...
        private void initializeView() {
            ...
            if (getTextSize() == 0) {
                setTextSize(getContext().getResources().getInteger(R.integer.ttlm_default_text_size));
            }
        ...
        void fadeIn(final long fadeDuration) {
            if (mShowing) {
                return;
            }
    ...
    public static final class Builder {
        ...
        int textSize = R.integer.ttlm_default_text_size;
